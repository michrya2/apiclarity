...
func CreateRESTServer(port int, speculator *_speculator.Speculator, dbHandler *database.Handler, authzmodelRepo bfladetector.AuthzModelRepository, bflaDetector bfladetector.BFLADetector) (*Server, error) {
	s := &Server{
